...
actor.load_state_dict(torch.load(actor_dir + "/actor_oracle_TS_re3.pth"))
...
proprio_encoder.load_state_dict(torch.load(proprio_encoder_dir + "/proprio_oracle_TS_re3.pth"))
