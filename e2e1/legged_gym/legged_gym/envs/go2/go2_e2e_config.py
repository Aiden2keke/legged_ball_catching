...
class GO2E2ECfg(LeggedRobotCfg):
    ...
    class commands(LeggedRobotCfg.commands):
        """Larger command ranges — robot MUST walk to reach targets."""
        max_speed = 1.5
        landing_time_min = 1.0
        landing_time_max = 10.0
        class ranges(LeggedRobotCfg.commands.ranges):
            pos_1 = [1.0, 4.0]     # radius 1-4m (was 0.5-1m!)
            pos_2 = [-3.14, 3.14]  # full circle
            heading = [-0.5, 0.5]
            use_polar = True
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        class scales(LeggedRobotCfg.rewards.scales):
            ...
            # Disabled
            termination = -0.
            stand_still_pos = 0.0      # DISABLED — was penalizing movement
...
class GO2E2ECfgPPO(LeggedRobotCfgPPO):
    ...
    class algorithm(LeggedRobotCfgPPO.algorithm):
        ...
        student_reinforcing = False  # Set False for first 7500 steps. Set True later for inference.
