...
def load_policy(logdir):
    ...
    actor.load_state_dict(torch.load('/home/unitree/program/legged_ball_catching/mujoco_test/model/rsl_rl_teacher_student/actor/actor_oracle12-9000.pth'))
    actor = actor.to('cpu')
    actor.eval()

    proprio_encoder = MLPEncoder(input_dim=5*46)
    proprio_encoder.load_state_dict(torch.load('/home/unitree/program/legged_ball_catching/mujoco_test/model/rsl_rl_teacher_student/proprio_encoder/proprio_oracle12-9000.pth'))
